...
void main() {
  group('CharacterBanner cacheWidth', () {
    ...
    testWidgets(
      'character image cacheWidth should be 132 (44 × 3)',
      (tester) async {
        await tester.pumpWidget(
          buildTestWidget(AiCharacter.warmCounselor),
        );
    ...
    testWidgets(
      'character image cacheHeight should be 132',
      (tester) async {
        await tester.pumpWidget(
          buildTestWidget(AiCharacter.warmCounselor),
        );
    ...
    testWidgets(
      'cache size is 3× display size (44 × 3 = 132)',
      (tester) async {
        await tester.pumpWidget(
          buildTestWidget(AiCharacter.realisticCoach),
        );
        await tester.pump(const Duration(milliseconds: 100));
    ...
    testWidgets(
      'all AiCharacter values should have consistent cacheWidth',
      (tester) async {
