...
void main() {
  ...
  group('DiaryImageGallery cacheWidth', () {
    ...
    testWidgets('cacheWidth = screen_width/2 * DPR (400w, 3.0 DPR → 600)', (
      tester,
    ) async {
    ...
    testWidgets('cacheWidth = screen_width/2 * DPR (800w, 2.0 DPR → 800)', (
      tester,
    ) async {
    ...
    testWidgets('cacheWidth is null when MediaQuery.size is zero', (
      tester,
    ) async {
      await tester.pumpWidget(
        buildTestWidget(
    ...
    testWidgets('DPR 1.0: 360w → cacheWidth 180', (tester) async {
      await tester.pumpWidget(
        buildTestWidget(
          imagePaths: ['/fake/image1.png'],
          screenWidth: 360,
    ...
    testWidgets('cacheWidth and cacheHeight should be equal (square tiles)', (
      tester,
    ) async {
      await tester.pumpWidget(
        buildTestWidget(
