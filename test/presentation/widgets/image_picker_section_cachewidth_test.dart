...
void main() {
  group('ImagePickerSection cacheWidth', () {
    ...
    testWidgets('preview tile cacheWidth should be 240 (80 × 3)', (
      tester,
    ) async {
    ...
    testWidgets('preview tile cacheHeight should be 240', (tester) async {
      await tester.pumpWidget(buildTestWidget());
      await tester.pump(const Duration(milliseconds: 100));
    ...
    testWidgets('cache size is 3× display size (80 × 3 = 240)', (tester) async {
      await tester.pumpWidget(buildTestWidget());
      await tester.pump(const Duration(milliseconds: 100));
