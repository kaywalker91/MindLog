...
class DiaryFixtures {
  ...
  static Diary analyzed({
    ...
    analysisResult: AnalysisResult(
      ...
      emotionCategory: const EmotionCategory(primary: '기쁨', secondary: '성취감'),
  ...
  /// 안전 필터에 의해 차단된 일기
  static Diary safetyBlocked({String? id, DateTime? createdAt}) => Diary(
  ...
  /// 분석 실패한 일기
  static Diary failed({String? id, DateTime? createdAt}) => Diary(
  ...
  static List<Diary> mixed() => [
    ...
    analyzed(
      id: 'mix-4',
      createdAt: testNow.subtract(const Duration(hours: 3)),
    ),
    safetyBlocked(
      id: 'mix-5',
      createdAt: testNow.subtract(const Duration(hours: 4)),
    ),
  ];
  ...
  static List<Diary> withPinned() => [
    ...
    analyzed(
      id: 'normal-2',
      isPinned: false,
      createdAt: testNow.subtract(const Duration(hours: 6)),
    ),
  ];
